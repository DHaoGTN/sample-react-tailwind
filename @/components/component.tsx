...
return (<div className="bg-gray-100 min-h-screen flex items-center justify-center">
  <div className="max-w-sm rounded-lg shadow-lg bg-white p-6 space-y-6 border border-slate-200 border-gray-200 dark:border-gray-700 dark:border-slate-800">
      ...
      <Button className="w-full bg-black text-white" variant="outline">
        <div className="flex items-center justify-center">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M12 20.94c1.5 0 2.75 1.06 4 3 6-8 6-12.22A4.91 4.91 17 5c-2.22 0-4 1.44-5 2-1-.56-2.78-2-5-2a4.9 4.9 0-5 4.78C2 14 5 22 8 22c1.25 2.5-1.06 4-1.06Z" />
            <path d="M10 2c1 .5 2 5" />
          </svg>
          Login with Apple
        </div>
      </Button>
